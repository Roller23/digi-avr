...
static inline void SBR(uint32_t opcode);
static inline void CBR(uint32_t opcode);
static inline void INC(uint32_t opcode);
static inline void DEC(uint32_t opcode);
static inline void TST(uint32_t opcode);
static inline void CLR(uint32_t opcode);
...
static inline void BREQ(uint32_t opcode);
static inline void BRNE(uint32_t opcode);
static inline void BRCS(uint32_t opcode);
static inline void BRCC(uint32_t opcode);
static inline void BRSH(uint32_t opcode);
static inline void BRLO(uint32_t opcode);
static inline void BRMI(uint32_t opcode);
static inline void BRPL(uint32_t opcode);
static inline void BRGE(uint32_t opcode);
static inline void BRLT(uint32_t opcode);
static inline void BRHS(uint32_t opcode);
static inline void BRHC(uint32_t opcode);
static inline void BRTS(uint32_t opcode);
static inline void BRTC(uint32_t opcode);
static inline void BRVS(uint32_t opcode);
static inline void BRVC(uint32_t opcode);
static inline void BRIE(uint32_t opcode);
static inline void BRID(uint32_t opcode);

//bit and bit-test instructions
static inline void SBI(uint32_t opcode);
static inline void CBI(uint32_t opcode);
static inline void LSL(uint32_t opcode);
...
static inline void SEC(uint32_t opcode);
static inline void CLC(uint32_t opcode);
static inline void SEN(uint32_t opcode);
static inline void CLN(uint32_t opcode);
static inline void SEZ(uint32_t opcode);
static inline void CLZ(uint32_t opcode);
static inline void SEI(uint32_t opcode);
static inline void CLI(uint32_t opcode);
static inline void SES(uint32_t opcode);
static inline void CLS(uint32_t opcode);
static inline void SEV(uint32_t opcode);
static inline void CLV(uint32_t opcode);
static inline void SET(uint32_t opcode);
static inline void CLT(uint32_t opcode);
static inline void SEH(uint32_t opcode);
static inline void CLH(uint32_t opcode);
